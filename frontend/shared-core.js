var PetShared = (() => {
  ...
  // renderer/vendor-shared/index.ts
  var index_exports = {};
  ...
  // renderer/vendor-shared/constants.ts
  var CANVAS_H = 360;
  var FEET_Y = 330;
  ...
  // renderer/vendor-shared/pickers.ts
  ...
  // renderer/vendor-shared/motion.ts
  var planMove = (o) => {
  ...
  // renderer/vendor-shared/balance.ts
  var TIMEOUT_MS = 2e4;
  var RETRIES = 2;
  ...
  function balanceBubbleView(state) {
    if (state.ok) {
      ...
      return [
        ...
        { role: "label", text: "\uFF09\xA5" + (state.total ?? "-") }
      ];
    }
  ...
  // renderer/vendor-shared/whisper.ts
  var TIMEOUT_MS2 = 3e4;
  var RETRIES2 = 2;
  ...
  // renderer/vendor-shared/config.ts
  ...
  // renderer/vendor-shared/notify.ts
  var NOTIFY_ICONS = {
    done: "notify-done",
    error: "notify-error",
  ...
  // renderer/vendor-shared/menu.ts
  var EVENT_LABELS = {
    balance: "\u4F59\u989D\u6863\u4F4D",
    whisper: "\u788E\u788E\u5FF5",
    workStatus: "\u5DE5\u4F5C\u72B6\u6001"
  ...
  // renderer/vendor-shared/chat.ts
  ...
  // renderer/vendor-shared/physics.ts
  var SPRING_K = 200;
  var SPRING_C = 30;
  ...
  // renderer/vendor-shared/score.ts
  ...
  // renderer/vendor-shared/score-popup.ts
  ...
  // renderer/vendor-shared/work-status.ts
